...
- Added a direct nonblocking TCP write path for cached static responses, registering writable interest only under real backpressure instead of constructing the generic async-write path for every one-syscall response.
