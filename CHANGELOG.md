...
- Removed duplicate Tokio cooperative I/O budgeting from performance-mode plain HTTP connection tasks while retaining explicit 8/32-response fairness boundaries for static and raw reverse keep-alive lanes.
