...
- Rebalanced mixed saturation by yielding native stream reactors after two continuously-ready epoll batches; blocked sparse ticks reset the counter and retain the low-latency path.
