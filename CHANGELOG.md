...
- Replaced performance-mode plain HTTP per-connection tasks with four direct `SO_REUSEPORT` accept/readiness owners per CPU shard, avoiding mpsc dispatch and amortizing scheduler bookkeeping without collapsing every connection behind one owner.
