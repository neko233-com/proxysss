...
- Restored the data-shard I/O-driver interval to Tokio's 61-poll throughput default: idle shards still enter epoll immediately, while saturated small-packet queues avoid repeated empty driver checks.
