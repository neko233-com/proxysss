...
- Collapsed plain HTTP connection scheduling into one shard-local ready queue per pinned reactor to reduce high-concurrency per-task scheduler overhead while retaining socket locality.
