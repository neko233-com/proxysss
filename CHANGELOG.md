...
- Kept per-shard socket/reactor ownership without hard CPU affinity, allowing Linux CFS to rebalance uneven `SO_REUSEPORT` hashes and TLS/realtime siblings across the allowed cpuset.
