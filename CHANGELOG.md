...
- Split balanced realtime relay wake queues across `ceil(cpus / 3)` nice-7 owners, preserving the former aggregate CFS budget while reducing sparse TCP/WebSocket head-of-line latency.
