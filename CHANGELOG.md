...
- Replaced one-worker multi-thread plain HTTP shards with pinned current-thread Tokio runtimes, removing work-stealing bookkeeping while keeping every accepted connection on its owning CPU/reactor.
