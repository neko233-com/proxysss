...
- Removed the shared HTTP request-counter cache-line bounce with per-data-shard padded counters, restored a throughput/latency-balanced 16-poll I/O driver cadence, and let 16 MiB sendfile responses run to kernel backpressure instead of forcing eight scheduler slices per file.
