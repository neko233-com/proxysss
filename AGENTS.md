...
- One-second equal-offered-load plans must remain mathematically executable: when the desired scenario rate is below its connection count, interval phase offsets schedule the integer total instead of falsely requiring every connection to complete at least once.
