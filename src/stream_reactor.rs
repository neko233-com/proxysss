...
// Only nearly-idle reactors use a short reply spin. Mixed-load reactors return
// directly to epoll after each event batch so their per-core owners do not
// monopolize HTTP/TLS/UDP siblings.
